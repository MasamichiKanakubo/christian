...
completion = client.chat.completions.create(
    ...
    messages=[
        ...
        {
            "role": "user",
            "content": f"「{query}」という質問が来ています。データベースには似た質問として「{title}」というのがあり、その回答は「{description_text}」です.オタサーの姫風に2,3行で返してください. 文章には絵文字を多用します。回答の最後は、この回答が質問の答えになってるか確認してください",
        },
    ],
)
